...
Namespace DbItems
    ...
    Public Class User
        ...
        Public Property Id() As Nullable(Of Integer)       ' marked as nullable as db auto insert so we don't need to repo won't insert null fields  will return it back on add
